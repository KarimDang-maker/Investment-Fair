...
import { HeroEntrepreneurs } from './ui/hero-section';
    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <HeroEntrepreneurs>
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            {t('hero.entrepreneurs.title').split(' ')[0]} <span className="underline decoration-blue-300 decoration-4">{t('hero.entrepreneurs.title').split(' ').slice(1).join(' ')}</span>
          </motion.h1>
      ...
      <SectionContainer className="-mt-8">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-extrabold mb-4">
            {t('entrepreneurs.why.title').split(' ')[0]} <GradientText variant="primary" className="!from-blue-500 !to-blue-600">{t('entrepreneurs.why.title').split(' ').slice(1).join(' ')}</GradientText>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          <AnimatedCard variant="blue" delay={0} className="group">
            <div className="mb-6">
          ...
          <AnimatedCard variant="blue" delay={0.2} className="group">
            <div className="mb-6">
              <IconBadge icon={<Target />} variant="blue" size="lg" />
            </div>
            <h3 className="text-2xl font-bold mb-4 text-gray-900 group-hover:text-blue-600 transition-colors">
      ...
      <SectionContainer className="relative overflow-hidden">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-full mb-6">
            ...
            <span className="text-sm font-semibold text-blue-900">{t('cta.limited')}</span>
          </div>
          ...
          <Link to="/inscription?type=entrepreneur">
            <Button size="lg" className="bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
